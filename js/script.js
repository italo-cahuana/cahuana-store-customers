...
// Logíca para mostrar los precios 2, 3, 4. SOLO *SI* ESTAN OCULTOS POR DEFECTO EN CSS. en este caso si estan ocultos en CSS
...
document.getElementById('insta').addEventListener('click', instagram);// Aquí no se llama a la funcion directamente(porque si no se ejecutaría), aquí se hace "refenrencía" a al funcio, ya que no estamos poniendole los "()" y por ende solo se llama si se hace click al elemento "insta y linkedin"
...
// Logica para redirigir a whatsapp al hacer clic en la imagen de whatsapp
document.getElementById('trabajaconnosotros').addEventListener('click', () => redirigirAWhatsApp("trabajar con ustedes como revendedor ¿Me puedes brindar más información?"));
